...
This script uses a Chebyshev basis in the x-y-directions with Neumann boundary
conditions.
...
x_basis = de.Chebyshev('x', 128, interval=(-Lx/2, Lx/2))
y_basis = de.Chebyshev('y', 128, interval=(-Ly/2, Ly/2))
...
logger.info("Neumann BC: fixed flux in both directions")
