...
% \hdashline \\
% %
% \left[-Z + \frac{\eta}{(1-\eta)} \frac{1}{Re} \nabla^{2} + \frac{2im}{r^{2}}\right] I 
% & \rvline 
% & -im\Omega +  \frac{\eta}{(1-\eta)} \frac{1}{Re}\nabla^{2} 
% &\rvline 
% & \bigzero & \rvline &  \bigzero & \rvline & \left(\frac{-im}{r}\right)I_{g2gl}\\
% %
% \\
% \hdashline\\
% %
...
%  \\ 
% \hdashline\\
%   \tilde{D}_{1} + \frac{1}{r}I & \rvline & \left(\frac{im}{r}\right)I &\rvline & (ik)I & \rvline & \bigzero & \rvline & \bigzero\\
% \end{bmatrix}
% \begin{bmatrix}
%  u_{r}\\
%  u_{\theta}\\
...
% where
% \begin{equation}
%  \nabla^{2} = \left[\tilde{D}_{2} + \frac{1}{r}\tilde{D}_{1} - \left( \frac{m^{2} + 1}{r^{2}} + k^{2}\right)I\right]
% \end{equation}
